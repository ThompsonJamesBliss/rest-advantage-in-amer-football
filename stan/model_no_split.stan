...
model {
  ...
  for (g in 1:num_games) {
    Ey[g] = theta[home_team_code[g], season[g]] - theta[away_team_code[g], season[g]] + (alpha_ha_trend * season[g] + alpha_ha_intercept) * h_adv[g] + alpha_bye * bye[g] + alpha_mnf * mnf[g] + alpha_tnf * tnf[g];
  }
